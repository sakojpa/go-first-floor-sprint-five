...
func (r Running) Calories() float64 {
	waistCalories := (CaloriesMeanSpeedMultiplier*r.meanSpeed() + CaloriesMeanSpeedShift) * r.Weight / MInKm *
		r.Duration.Hours() * MinInHours
	return waistCalories
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	waistCalories := (CaloriesWeightMultiplier*w.Weight + (math.Pow(
		w.meanSpeed()*KmHInMsec, 2,
...
func (s Swimming) meanSpeed() float64 {
	// вставьте ваш код ниже
	r := float64(s.LengthPool*s.CountPool) / MInKm / s.Duration.Hours()
	return r
}
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	waistCalories := (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * s.Weight * s.Duration.Hours()
	return waistCalories
}
